...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>OLPA</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>OLPA</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $user_session['fullname']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo $user_session['fullname']; ?> - Web Developer
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('Welcome/password'); ?>" class="btn btn-default btn-flat">Change Password</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $user_session['fullname']; ?></p>
